...
// while (true) {
//   const vocaleScelta = prompt(
//     "hi playful child, try and guess the secret vowel"
//   );

//   const isVocaleSceltaUgualeAVocaleSegreta = vocaleScelta === vocaleSegreta;

//   if (isVocaleSceltaUgualeAVocaleSegreta) {
//     console.log("good job kid! You're a chmpion!");
//     break;
//   } else {
//     console.log("donkey");
//   }
...
// do {
//     console.log("sono nel ciclo while al giro" + counter1);
//     counter1 = counter1 + 1;
// } while (counter1 < 10); 
